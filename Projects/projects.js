...
.to(project1,0.3,{boxShadow:'50px -10px 99px #ff009d',ease:Power1.easeIn})
.to(project2,0.3,{boxShadow:'50px -10px 99px #ff009d',ease:Power1.easeIn})
.to(project4,0.3,{boxShadow:'50px -10px 99px #ff009d',ease:Power1.easeIn})
.to(project3,0.3,{boxShadow:'50px -10px 99px #ff009d',ease:Power1.easeIn})
